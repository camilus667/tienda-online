...
const Home: React.FC<HomeProps> = ({
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 pt-16 pb-6">
      {/* Search Bar */}
      <div className="pt-4 pb-2 space-y-3 bg-gray-50">
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 ring-primary bg-white shadow-sm" 
              value={searchTerm} 
